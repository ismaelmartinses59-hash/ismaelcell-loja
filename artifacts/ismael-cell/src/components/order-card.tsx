...
import { Share2, Play, AlertTriangle, CheckCircle2 } from "lucide-react";
      ...
      <CardContent className="p-0">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="bg-muted/50 border-t md:border-t-0 md:border-l p-5 flex flex-row md:flex-col items-center justify-center gap-2 min-w-[160px]">
            ...
            <Button size="sm" variant="outline" onClick={handleShare} className="w-full justify-start border-dashed">
